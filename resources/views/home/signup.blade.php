...
<link rel="shortcut icon" type="image/x-icon" href="/favicon.ico">
    <title>Topchoice Information Technologies Limited</title>
...
<body>
    ...
    <div class='major' >
        ...
        <div class="row">
            ...
            <div class="contact top-50 " style="background: #008080;">
                ...
                <form class='contact-form'>
                    <div class="form-column">
                        ...
                        <div class="input-wrapper">
                            ...
                            <i class="fa fa-eye" aria-hidden="true" onclick="toggleMany(this)"></i>
                        </div>
                        ...
                        <progress max="100" value="0" id="meter"></progress> <span class="textbox text-center"></span>
                      ...
                      <div class="row-center" style="margin-top: 40px;"">
                          <button type='submit' class='submit-btn' style="background: #FFF; color:#000; border-radius:50px">
                              Start Free Trial
                          </button>
                      </div>
                  </form>
